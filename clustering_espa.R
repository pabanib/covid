...
filas <- c('mes2','mes3','mes4','mes5','mes6','mes7','mes8','mes9','mes10','mes11','mes12','mes13','mes14','mes15','mes16')
filas2 <- c('mes0','mes1','mes2','mes3')
filas3 <- c('mes0','mes1','mes2','mes3','mes4','mes5','mes6')
clusters <- function(df, nombre,filas){
datos <- df[filas]
skater <- skater(5, w_knn6, datos)
redcap <- redcap(5, w_knn6, datos, "fullorder-completelinkage")
schc <- schc(5,w_knn6,datos, 'complete')
